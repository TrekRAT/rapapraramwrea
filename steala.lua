...
local TELEPORT_KEY = Enum.KeyCode.J

-- Melee Spammer Settings
local SPAMMER_TOGGLE_KEY = Enum.KeyCode.L
...
UserInputService.InputBegan:Connect(function(input, processed)
    ...
    elseif input.KeyCode == SPAMMER_TOGGLE_KEY then
        if isSpamming then
            stopSpamming()
        else
            startSpamming()
